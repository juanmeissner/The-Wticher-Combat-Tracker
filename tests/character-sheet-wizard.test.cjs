...
assert.match(wizardSource, /Importar ficha/);
assert.match(wizardSource, /characterSheetImportInput/);
assert.match(wizardSource, /importCharacterSheetFile\(event\)/);
...
assert.match(wizardSource, /getCharacterSkillRecommendationProfile/);
assert.match(wizardSource, /Prioridades de/);
assert.doesNotMatch(wizardSource, /skill\.recommendedProfessionIds\?\.includes\(professionId\)/);
assert.match(wizardCss, /character-skill-path-guidance/);
...
assert.match(wizardSource, /Hoje na campanha/);
assert.match(wizardSource, /characterWizardAgeBadge/);
assert.match(wizardSource, /updateCharacterWizardBirthSummary/);
