...
assert.match(expandedResources, /Necessidades/);
assert.match(expandedResources, /Fome/);
assert.match(expandedResources, /Sede/);
assert.match(expandedResources, /Sono/);
assert.match(expandedResources, /Higiene/);
assert.match(expandedResources, /100%/);
assert.match(expandedResources, /adjustCharacterCombatResource/);
assert.match(expandedResources, /adjustCharacterNeed/);
