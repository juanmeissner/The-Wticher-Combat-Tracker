    ...
    async function openWorldTravelPlanner(destinationId = '') {
        ...
        modal.innerHTML = `<section class="session-dialog world-time-dialog world-travel-dialog" role="dialog" aria-modal="true" aria-label="Planejar viagem do grupo">
            <form onsubmit="confirmWorldTravel(event)">
                ...
                <div class="world-travel-map-window"><div class="world-travel-map-zoom" aria-label="Controles de zoom do mapa"><button type="button" onclick="worldMap.zoomOut()" aria-label="Diminuir zoom" title="Diminuir zoom">−</button><button type="button" onclick="worldMap.zoomIn()" aria-label="Aumentar zoom" title="Aumentar zoom">+</button></div><button type="button" class="world-travel-current-button" onclick="worldMap.focusCurrentLocation()" title="Voltar ao local atual"><span aria-hidden="true">◎</span><b>Local atual</b></button></div>
                ...
                <section class="world-travel-bottom-sheet">
                    ...
                    <nav class="world-travel-command-bar" aria-label="Ações da viagem"><button type="button" class="world-travel-command" data-world-travel-toggle="party" aria-controls="worldTravelPartyPanel" aria-expanded="false" onclick="toggleWorldTravelPanel('party')"><span aria-hidden="true">👥</span><small>Grupo</small></button><button id="worldTravelConfirmButton" type="submit" class="world-travel-confirm-button" disabled><span aria-hidden="true">➤</span><b>Viajar</b></button><button type="button" class="world-travel-command" data-world-travel-toggle="settings" aria-controls="worldTravelSettingsPanel" aria-expanded="false" onclick="toggleWorldTravelPanel('settings')"><span aria-hidden="true">⚙</span><small>Opções</small></button><button type="button" class="world-travel-command world-travel-close-command" title="Fechar" aria-label="Fechar planejador e voltar ao mapa" onclick="closeWorldTravelPlanner()"><span aria-hidden="true">×</span></button></nav>
                </section>
            </form>
        </section>`;
