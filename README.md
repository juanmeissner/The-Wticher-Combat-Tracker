...
- círculos verdes nomeados como `location|Nome` no SVG do CorelDRAW são importados como coordenadas precisas; a importação atual posiciona **144 marcadores**, sem nomes desconhecidos ou ambíguos, e mantém os demais locais do catálogo inalterados;
...
- a camada **Rede de estradas** utiliza atualmente **270 trechos vetoriais** traçados pelo mestre no CorelDRAW sobre as linhas do mapa: **129 principais**, **126 regionais** e **15 caminhos de montanha**;
- **217 nós** conectam localidades e pontos intermediários, com **116 entroncamentos** identificados automaticamente pela topologia da rede;
...
- a caminhada possui velocidade máxima de **4 km/h**, carroças e carruagens de **6 km/h** e cavalos de **8 km/h**; Movimento e tipo de estrada ainda podem reduzir esses valores, mantendo sempre a ordem caminhada → veículo → cavalo para condições equivalentes;
...
- cavalos levam o cavaleiro e somente um passageiro adicional; assim que a vaga é ocupada, aquela carona desaparece dos seletores dos demais personagens e volta a ficar disponível quando for liberada;
...
- no planejamento em grupo, o mapa permanece dominante: origem e destino ficam compactos no topo, o destino possui busca com sugestões em tempo real, tempo, distância, velocidade e ritmo aparecem em um resumo flutuante, e participantes, transportes, NPCs, visibilidade e avanço do relógio ficam recolhidos na barra inferior;
- o local atual permanece destacado em verde, o destino da rota usa roxo e os botões `◎` recentralizam o mapa no ponto onde o grupo está;
...
- recomendações de perícias contextualizadas para cada subclasse e escola de bruxo, com prioridades próprias e uma explicação do estilo do caminho escolhido;
- todas as escolas preservam suas especialidades e também destacam Intimidação e Resistir Coerção como competências fundamentais de Witcher;
- destaque visual das recomendações durante a distribuição, diferenciando, por exemplo, a precisão e sobrevivência do Arqueiro da defesa e controle de linha da Vanguarda;
